...
class BannerpackageController extends PanelController
{
	public function setup()
	{
		...
		|--------------------------------------------------------------------------
		*/
		$this->xPanel->setModel('App\Models\Bannerpackages');
		$this->xPanel->setRoute(admin_uri('bannerpackages'));
		$this->xPanel->setEntityNameStrings("Add Banner Package", "Add Banner Packages");
