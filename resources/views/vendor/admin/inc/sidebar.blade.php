	...
	<aside class="main-sidebar" id="adminSidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li><a href="{{ admin_url('bannerads') }}"><i class="fa fa-picture-o"></i> <span>Bottom Banner</span></a></li>
				...
				@endif
				<li><a href="{{ admin_url('send-mail') }}"><i class="fa fa-envelope"></i> <span>Send Email</span></a></li>
				{!! $pluginsMenu !!}
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						@endif
						@if (auth()->user()->can('list-package') || userHasSuperAdminPermissions())
						<li><a href="{{ admin_url('bannerpackages') }}"><i class="fa fa-pie-chart"></i> <span>Banner Package</span></a></li>
						@endif
						
						<li><a href="{{ admin_url('slider') }}"><i class="fa fa-picture-o" aria-hidden="true"></i><span>Slider</span></a></li>
					    ...
					    <li><a href="{{ admin_url('menu') }}"><i class="fa fa-bars" aria-hidden="true"></i> <span>Menu</span></a></li>  
						@endif
						@if (
							auth()->user()->can('list-country') ||
							auth()->user()->can('list-currency') ||
