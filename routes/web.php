...
Route::group([
	...
	Route::group([
		...
		CRUD::resource('bannerpackages', 'BannerpackageController');
		...
		CRUD::resource('bannerads', 'BottombannerController');
		...
		Route::post('sub_mail', 'SendMailController@sub_mail');
		Route::get('view_email_list', 'SendMailController@view_email_list');
...
Route::group([
	...
	Route::group(['middleware' => ['web']], function ($router) {
		...
		Route::get('/morepost', 'HomeController@getallmyposts');
		//getchildallcategory
		Route::get('/getchildallcategory', 'HomeController@getchildallcategory');
		...
		Route::get('bottombanner/addbanner', 'BannerController@create');
		Route::post('bottombanner/addbanner', 'BannerController@savebanner');
		
	   Route::get('bottombanner/{id}/payment', 'PaymentbannerController@getForm');
	   Route::post('bottombanner/{id}/payment', 'PaymentbannerController@postForm');
	   Route::get('bottombanner/{id}/success', 'PaymentbannerController@success');
	   Route::post('bottombanner/{id}/success', 'PaymentbannerController@success');	
	   Route::get('bottombanner/successbanner', 'PaymentbannerController@successbanner');
	   Route::post('bottombanner/successbanner', 'PaymentbannerController@successbanner');	
	   Route::get('bottombanner/fanish', 'PaymentbannerController@fanish');
		...
		Route::group(['namespace' => 'Post'], function ($router) {
			...
			// $router->pattern('slug', '.*');
			$router->pattern('slug', '^(?=.*)((?!\/).)*$');
			Route::get('posts/banneroption', 'CreateController@banneroption');
		...
		Route::group(['prefix' => 'ajax'], function ($router) {
			...
			//Route::get('category/find_city', 'Ajax\CategoryController@find_city');
