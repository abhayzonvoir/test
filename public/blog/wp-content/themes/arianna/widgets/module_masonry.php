<?php
/**
 * Plugin Name: Arianna: Masonry Module
 ...
 */
add_action('widgets_init', 'arianna_register_masonry_module');

function arianna_register_masonry_module(){
	register_widget('arianna_masonry');
}
 ...
 *
 */ 
class arianna_masonry extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-masonry', 'description' => esc_html__('[Full-width module][Content module] Displays posts with masonry layout in content section.', 'arianna'));
		
		/* Create the widget. */
		parent::__construct('arianna_masonry', esc_html__('*arianna: Module Masonry', 'arianna'), $widget_ops);
	}
        ...
        <div id="<?php echo esc_attr($uid);?>" class="module-masonry-wrapper clear-fix">
            <div class="masonry-content-container">
                <?php while ( $query -> have_posts() ) : $query -> the_post(); ?>
                    <?php echo arianna_masonry_render(get_the_ID());?>
                <?php endwhile;?>
            </div>	
