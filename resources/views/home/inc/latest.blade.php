	...
	<div class="container">
		<div class="col-lg-12 content-box layout-section">
			<div class="row row-featured row-featured-category">
				...
				<div class="adds-wrapper noSideBar" id="moreposts">
					<?php
		...
		<a href="javascript:void(0);" class="vewmore btn btn-default mt10">
							 LOAD MORE
						</a>
				<div class="clearfix"></div>	
 <div id="carousel-example" class="carousel slide" data-ride="carousel" data-interval="2000" style="margin-top:50px;">
  ...
  ?>
    <div class="item <?php echo $active; ?>">
      <a href="<?php echo $bannerlink; ?>"><img src="/storage/<?php echo $banner->bannername; ?>" /></a>
...
@section('after_scripts')
	...
	$(document).on('change', '.mycategory', function() {
        var categoryid = $(this).val();
		  $.ajax({
                type : 'GET',
                url: "getchildallcategory?categoryid=" +categoryid,
				 dataType: "json",
       ...
       $(document).on('click','.searchoxcat',function(){
		   $('.searchoxcat').removeClass('searchactive');
		    $(this).addClass('searchactive');
			$('.formc').addClass('formactive');
		   var categoryid = $(this).attr('categoryid');
		  $('.mycategory').val(categoryid);
		  $('.searchcategory').slideDown();
		  $('.searchtitle').slideUp();
		  $('.mycategory').trigger("change");
		   
	   });
		$('.vewmore').click(function(){
            $.ajax({
                type : 'GET',
                url: "morepost?page=" +pageNumber,
                success : function(data){
