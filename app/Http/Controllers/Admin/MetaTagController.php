	...
	public function setup()
	{
		...
		*/
		...
		$this->xPanel->addField([
			...
			'hint'       => trans('admin::messages.You can use dynamic variables such as {app_name} and {country} - e.g. {app_name} will be replaced with the name of your website and {country} by the selected country or {city} for the current city'),
		]);
		$this->xPanel->addField([
			'name'       => 'description',
			'label'      => trans("admin::messages.Description"),
