<?php
/**
 * Plugin Name: Arianna: Slider Widget
 ...
 */
add_action('widgets_init', 'arianna_register_slider_widget');

function arianna_register_slider_widget(){
	register_widget('arianna_slider');
}
 ...
 *
 */ 
class arianna_slider extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'widget-slider', 'description' => esc_html__('[Sidebar widget] Displays a slider in sidebar.', 'arianna'));
		
		/* Create the widget. */
		parent::__construct('arianna_slider', esc_html__('*arianna: Widget Slider','arianna'), $widget_ops);
	}
