<?php
/**
 * Plugin Name: Arianna: Large Blog Module
 ...
 */
add_action('widgets_init', 'arianna_register_large_blog_module');

function arianna_register_large_blog_module(){
	register_widget('arianna_large_blog');
}
 ...
 *
 */ 
class arianna_large_blog extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */	
		$widget_ops = array('classname' => 'module-large-blog', 'description' => esc_html__('[Full-width module][Content module] Displays latest posts in large blog layout in content section.','arianna'));
		
		/* Create the widget. */
		parent::__construct('arianna_large_blog', esc_html__('*arianna: Module Large Blog','arianna'), $widget_ops);
	}
